...
We worship with traditional Lutheran hymns and liturgy, sung and spoken in Telugu, Hindi, Tamil, and English. GSSAM continues the ministry of Good Shepherd Lutheran Church at 4211 Carol Ave in Fremont, serving families across the East Bay and South Bay.
...
Come early for carol singing. A light reception follows worship.`,
  ...
  await db.galleryImage.createMany({
    data: gallery.map(([n, title, album]) => ({
      title,
      album,
